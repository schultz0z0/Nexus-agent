...
$RepoUrlSsh = "git@github.com:schultz0z0/Nexus-agent.git"
$RepoUrlHttps = "https://github.com/schultz0z0/Nexus-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/schultz0z0/Nexus-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/schultz0z0/Nexus-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/schultz0z0/Nexus-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
